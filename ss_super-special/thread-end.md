...
canonical_path: "ss_super-special/thread-end.md"
previous_path: "s_special/thread-end.md"
compatibility_stub_path: "s_special/thread-end.md"
...
migration_mode: "copy_promote_plus_compatibility_stub"
stage: "ss_primary_candidate"
...
`ss_super-special/thread-end.md` は、Thread終了処理の現在Gateを判定するためのSS級Primary Runtime Entryである。

このfileは、`s_special/thread-end.md` から昇格した Thread-End Parent Map であり、Thread終端の Single Front Door / Multi-Gate Router として扱う。
...
`ss_super-special/thread-end.md` は、Thread終端の Single Front Door / Multi-Gate Router である。
...
delegation:
  ...
  handoff_details:
    route_to: "s_special/thread-handoff.md"
    status: "living_candidate / created / not_final_seal"
