...
基本Route：
    ...
    load_router:
      ...
      _skill/skills/ai-journaling.md:
        load_when: "HumanがJournalingしたいが何を書けばよいか分からない時、またはAI-assisted Reflectionを開始・継続・閉じる時"
        read_as: "Evidence-First Reversible Journaling Skill with AI Open Slot"
...
## 12. AI Skill Pair and Application Skill / 初期Skill構成
...
現在のApplication Skill：
    ...
    ai-journaling.md
      = Human Realityから次の一問を選び、One Open Slotを残すJournaling Skill。
...
Pair compression：
    ...
    AI-JournalingでHuman Realityから問いと余白を開く。
