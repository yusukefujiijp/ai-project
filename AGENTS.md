...
= Current Domain and Mission Route

ss_super-special/CHATGPT.md
= All-Project Covenant Map / Stone Tablet
...
instruction_precedence:
  ...
  2: "User-specified sources and read order"
...
→ Human Activation
→ Full Rail within approved scope
→ Reality Review
→ Next Gate / Harvest
```
...
Core:
  ...
  Guard is Gate, not disappearance.
...
> Future AI should restart from the right coordinate—and choose the first legal move.**
